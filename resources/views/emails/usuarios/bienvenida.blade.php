                            ...
                            <tr>
                                <td name="bmeMainColumnParent"
                                    ...
                                    <table name="bmeMainColumn" class="bmeMainColumn"
                                        style="max-width: 100%; overflow: visible;" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" class="blk_container bmeHolder"
                                                                    ...
                                                                    style="border: 0px none transparent; background-color: rgb(245, 242, 208);"
                                                                    bgcolor="#f5f2d0">
                                                                                    ...
                                                                                    <td>
                                                                                        <table width="100%"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="bmeImage"
                                                                                                        style="padding: 15px 20px; border-collapse: collapse;"
                                                                                                        align="center">
                                                                                                        <img src="https://benchmarkemail.com/images/templates_n/new_editor/Templates/School/BackToSchool.png"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td style="border-radius: 0px; border: 1px solid rgb(69, 153, 232); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 40px; font-weight: normal; border-collapse: separate;"
                                                                                                                        class="bmeButtonText">
                                                                                                                        <span
                                                                                                                            style="font-family: 'Arial Narrow', 'Arial MT Condensed Light', sans-serif; font-size: 24px; color: rgb(236, 127, 232);">
                                                                                                                            <a style="color: rgb(236, 127, 232); text-decoration: none;"
                                                                                                                                target="_blank">
                                                                                                                                ¡Hola
                                                                                                                                {{ $user->name }}!
                                                                                                                            </a>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="bmeButtonText"
                                                                                                                        style="border-radius: 0px; border: 0px none transparent; text-align: center; padding: 20px 40px; font-weight: normal; font-family: Arial, Helvetica, sans-serif; font-size: 14px; background-color: rgb(69, 153, 232);">
                                                                                                                        <span
                                                                                                                            style="font-family: 'Arial Narrow', 'Arial MT Condensed Light', sans-serif; font-size: 20px; color: rgb(255, 255, 255);">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left"
                                                                                                                                        ...
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDB&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1"
                                                                                                                                            target=_blank
                                                                                                                                            style="display: inline-block;background-color: rgb(53, 91, 161);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);"
                                                                                                                                            target="_blank"><img
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left"
                                                                                                                                        ...
                                                                                                                                        width="24"
                                                                                                                                        style="padding-right:10px;height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDD&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1"
                                                                                                                                            target=_blank
                                                                                                                                            style="display: inline-block;background-color: rgb(50, 203, 255);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);"
                                                                                                                                            target="_blank"><img
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left"
                                                                                                                                        ...
                                                                                                                                        width="24"
                                                                                                                                        style="padding-right:10px;height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=778415B&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1"
                                                                                                                                            target=_blank
                                                                                                                                            style="display: inline-block;background-color: rgb(82, 127, 166);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgb(0, 0, 238);"
                                                                                                                                            target="_blank"><img
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left"
                                                                                                                                        ...
                                                                                                                                        width="24"
                                                                                                                                        style="height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=7C39F5A&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1"
                                                                                                                                            target=_blank
                                                                                                                                            style="display: inline-block;background-color: rgb(202, 31, 39);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgb(0, 0, 238);"
                                                                                                                                            target="_blank"><img
                                                                                                                                                src="https://ui.benchmarkemail.com/images/editor/socialicons/pi_btn.png"
                                                                                                                                                alt="Pinterest"
                                                                                                                                                style="display: block; max-width: 114px;"
                                                                                                                                                border="0"
                                                                                                                                                width="24"
                                                ...
                                                <td width="100%" class="blk_container bmeHolder" name="bmeFooter"
                                                    ...
                                                    <div id="dv_5" class="blk_wrapper">
                                                        <table width="600" cellspacing="0" cellpadding="0"
                                                            border="0" class="blk" name="blk_permission"
                                                            style="">
                                                            <tbody>
                                                                <tr>
                                                                    <td name="tblCell" class="tblCell"
                                                                        style="padding:20px;" valign="top"
                                                                        align="left">
                                                    ...
                                                    <div id="dv_7" class="blk_wrapper">
                                                        <table width="600" cellspacing="0" cellpadding="0"
                                                            border="0" class="blk" name="blk_footer"
                                                            style="">
                                                            <tbody>
                                                                <tr>
                                                                    <td name="tblCell" class="tblCell"
