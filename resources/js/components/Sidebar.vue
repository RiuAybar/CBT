				...
				<div class="d-flex justify-content-center">
					...
					<div class="flex-grow-1 ps-2">
						...
						<div class="dropdown-menu dropdown-menu-start">
							...
							<a class='dropdown-item' href='/pages-settings'><i class="align-middle me-1"
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-item active">
					...
					<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-alerts'>Alerts <span
						...
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-general'>General</a>
						</li>
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-grid'>Grid</a>
						</li>
						<li class="sidebar-item active"><a class='sidebar-link' href='/ui-modals'>Modals <span
									class="sidebar-badge badge bg-primary">Pro</span></a></li>
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-offcanvas'>Offcanvas <span
									class="sidebar-badge badge bg-primary">Pro</span></a>
						</li>
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-placeholders'>Placeholders <span
									class="sidebar-badge badge bg-primary">Pro</span></a>
						</li>
						<li class="sidebar-item">
							<a class='sidebar-link' href='/ui-tabs'>Tabs <span
									class="sidebar-badge badge bg-primary">Pro</span></a>
						</li>
						<li class="sidebar-item">
				...
				<li class="sidebar-item">
					...
					<ul id="forms" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
						<li class="sidebar-item"><a class='sidebar-link' href='/forms-basic-inputs'>Basic Inputs</a>
						</li>
				...
				<li class="sidebar-item">
					...
					<ul id="datatables" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
						...
						<li class="sidebar-item"><a class='sidebar-link' href='/tables-datatables-multi'>Multi Selection
								<span class="sidebar-badge badge bg-primary">Pro</span></a></li>
						<li class="sidebar-item"><a class='sidebar-link' href='/tables-datatables-ajax'>Ajax Sourced
