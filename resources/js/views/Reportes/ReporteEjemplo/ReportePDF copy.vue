<template>
  <div class="container mt-4">
    ...
    <div class="container" ref="pdfContent" style="visibility: hidden; position: absolute; left: -9999px; width: 210mm;">
      <div class="reporte-container">
        ...
        <div class="text-center mb-3">
          ...
          <h4 class="mt-3"><strong>REGISTRO DE FALTAS DE ASISTENCIA, CALIFICACIONES Y PROMEDIO POR ASIGNATURA</strong></h4>
        </div>
        ...
        <table class="table table-bordered table-sm mb-3">
          <tbody>
            ...
            <tr>
              <td rowspan="6"><strong>DE BACHILLERATO TECNOLÓGICO</strong><br><strong>CBT, AMANALCO DE BECERRA</strong></td>
              <td>FEBRERO</td>
              <td>20</td>
            </tr>
            <tr>
